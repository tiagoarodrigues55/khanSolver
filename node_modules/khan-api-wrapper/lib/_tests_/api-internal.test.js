...
test.skip("/api/internal/user/missions endpoint works", async () => {
  ...
  const internalUserMissions = await kapi.internalUserMissions()

  expect(typeof internalUserMissions).toBe("object")
  expect(Array.isArray(internalUserMissions.missions)).toBe(true)
})
